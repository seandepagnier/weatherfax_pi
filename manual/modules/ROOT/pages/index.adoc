...
https://www.youtube.com/watch?v=Ks4JwUYu84w[How to update file souces for OpenCPN weatherfax plugin]  Keep in mind that the World Regional weatherfaxInternetRetrieval (xml) files are now separated.
