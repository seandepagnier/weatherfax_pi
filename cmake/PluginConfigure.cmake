...
message(STATUS "Before check CLOUDSMITH_BASE_REPOSITORY: ${CLOUDSMITH_BASE_REPOSITORY}")
message(STATUS "Before check GIT_REPOSITORY: ${GIT_REPOSITORY}")
#if(NOT ${CLOUDSMITH_BASE_REPOSITORY} AND NOT ${GIT_REPOSITORY} STREQUAL "")
if(NOT DEFINED CLOUDSMITH_BASE_REPOSITORY)
